...
namespace LogMonitorTests
{
    ...
    public:
        ...
        TEST_METHOD(TestErrorLevelMonitor)
        {
            ...
            EventMonitor eventMonitor(eventChannels, true, false, false);
        ...
        TEST_METHOD(TestStartAtOldestRecord)
        {
            ...
            EventMonitor eventMonitor(eventChannels, true, true, false);
            Sleep(WAIT_TIME_EVENTMONITOR_START);
        ...
        TEST_METHOD(TestChannelsAreNotMixed)
        {
            ...
            EventMonitor eventMonitor(eventChannels, false, false, false);
            Sleep(WAIT_TIME_EVENTMONITOR_START);
